...
namespace JigsawPuzzleSolver
{
    ...
    public class Piece
    {
        ...
        public PieceEdge[] Edges { get; set; } = new PieceEdge[4];
        public PieceTypes PieceType { get; set; }

        //**********************************************************************************************************************************************************************************************

        public Piece(Image<Rgb, byte> sourceImg, Image<Gray, byte> mask)
        {
            SourceImg = sourceImg;
            Mask = mask;
        ...
        public void InitPieceEdges()
        {
            ...
            for(int edgeNo = 0; edgeNo < 4; edgeNo++)
            {
                ...
                Edges[edgeNo] = new PieceEdge(PieceID, Mask.Copy(edgeRect), (EdgeLocations)edgeNo);
