...
{
    // see: https://www.codeproject.com/Articles/18936/A-C-Implementation-of-Douglas-Peucker-Line-Approxi
    public static class DouglasPeuckerLineApprox
    {
        /// <summary>
        ...
        private static void DouglasPeuckerReduction(List<PointF> points, Int32 firstPoint, Int32 lastPoint, Double tolerance, ref List<Int32> pointIndexsToKeep)
        {
